...
switch (images) {
  ...
  case 1:
    document.getElementById("win-lose").innerText =
      "Meditating goat, tubular!!";
    break;
  case 2:
    document.getElementById("win-lose").innerText =
      "My cat wouldn't even lay in that!!";
    break;
  case 3:
    document.getElementById("win-lose").innerText = "What a cool stool!!";
    break;
  case 4:
    document.getElementById("win-lose").innerText = "EW, gross!!";
    break;
  case 5:
    document.getElementById("win-lose").innerText = "AHHHHHH!!";
    break;
}
...
function restartGame() {
  ...
  document.getElementById("win-lose").innerText =
    "Do you think fate is on your side? Let's play!!";
}
...
function doorOne() {
  ...
  switch (rand) {
    case 0:
      document.getElementById("door-image").src = images[0];
      break;
    case 1:
      document.getElementById("door-image").src = images[1];
      break;
    case 2:
      document.getElementById("door-image").src = images[2];
      break;
    case 3:
      document.getElementById("door-image").src = images[3];
      break;
    case 4:
      document.getElementById("door-image").src = images[4];
      break;
    case 5:
      document.getElementById("door-image").src = images[5];
      break;
  }
...
function doorTwo() {
  ...
  switch (rand) {
    case 0:
      document.getElementById("door-image2").src = images[0];
      break;
    case 1:
      document.getElementById("door-image2").src = images[1];
      break;
    case 2:
      document.getElementById("door-image2").src = images[2];
      break;
    case 3:
      document.getElementById("door-image2").src = images[3];
      break;
    case 4:
      document.getElementById("door-image2").src = images[4];
      break;
    case 5:
      document.getElementById("door-image2").src = images[5];
      break;
  }
...
function doorThree() {
  ...
  switch (rand) {
    case 0:
      document.getElementById("door-image3").src = images[0];
      break;
    case 1:
      document.getElementById("door-image3").src = images[1];
      break;
    case 2:
      document.getElementById("door-image3").src = images[2];
      break;
    case 3:
      document.getElementById("door-image3").src = images[3];
      break;
    case 4:
      document.getElementById("door-image3").src = images[4];
      break;
    case 5:
      document.getElementById("door-image3").src = images[5];
      break;
  }
